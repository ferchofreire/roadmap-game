...
class Partidas {
    ...
    public static function GuardarPartida($conn){
    ...
    public static function CargarPartida($conn){
    ...
    public static function SetupsPartidas($conn){
    ...
    public static function SumarTiempo($times) {
    ...
    public static function CambiarPassword($conn){
        $old = $_POST["oldPss"];
        $new = $_POST["newPss"];

    ...
    clearInterval(Passarela)
      ...
      if(parseInt(IdPartidaActiva.SprintAct) > 0){
        ...
        if(parseInt(IdPartidaActiva.SprintAct) == 1 )
         {Mensaje(true, "Aún no hay estado de resultados")
          Pantalla = 0}
        ...
        usersend = () =>{
            ...
            // Cargamos Valores guardados
                ...
                ordenA = [null, null, null, 15,16,17,18,19,5,6,7,8,9,20,10,11,12,13,14,0,1,2,3,4,5,21,22,23]
                ordenB = [null, null, null, "1_scale","1_experience","1_capital","1_reputation","1_distribution","2_size_supliers","2_price_sesibilities","2_technicalcost","2_brandcost","2_abilityintegrate","3_availabiliti","4_effectivecompetitors","4_market","4_diferentation","4_strategicstackes","4_protectstackes","5_sizecostumers","5_pricesesibilities","5_thecnicalcost","5_brandcost","5_abilityintegrate","6_impactchanges","7_relations","8_others"]
